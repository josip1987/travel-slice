...
var MobileMenu = function () {
	function MobileMenu() {
		...
		//run constructor when object is created with MobileMenu class
...
var StickyHeader = function () {
	...
	_createClass(StickyHeader, [{
		...
		value: function createHeaderWaypoint() {
			var that = this;
			new Waypoint({
				element: this.headerTriggerElement[0], //first item in jquery object always points to a native dom element
...
new _RevealOnScroll2.default((0, _jquery2.default)(".feature-item"), "85%"); //one instance for features, one for testimonials
